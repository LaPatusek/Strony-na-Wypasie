    ...
    <div className={styles.footer}>
      <div className={`${styles['upper-footer']} grid`}>
        ...
        <div className={`${styles.socials} font-center`}>
          <h3>Social media</h3>
          <a href='asd' className={styles.Facebook} aria-label='FaceBook'>
            <Facebook size='32' />
          </a>
          <a href='asd' className={styles.Linkedin} aria-label='Linkedin'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='32px'
              height='32px'
          ...
          <a href='asd' className={styles.Twitter} aria-label='Twitter'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='32px'
              height='32px'
          ...
          <a href='insta' className={styles.Instagram} aria-label='Instagram'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='32px'
              height='32px'
